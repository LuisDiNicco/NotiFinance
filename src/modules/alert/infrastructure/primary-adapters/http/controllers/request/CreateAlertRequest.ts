...
export class CreateAlertRequest {
    @ApiPropertyOptional({ description: 'Optional asset id for asset-scoped alerts' })
    @IsOptional()
    @IsUUID()
    ...
    @ApiPropertyOptional({ example: 'MEP', description: 'Period or subtype marker (e.g. dollar type)' })
    @IsOptional()
    @IsString()
