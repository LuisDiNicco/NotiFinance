...
import { USER_REPOSITORY, type IUserRepository } from '../../../application/IUserRepository';
...
export class DemoUsersCleanupJob {
    ...
    public async cleanupExpiredDemoUsers(): Promise<void> {
        ...
        const deleted = await this.userRepository.deleteExpiredDemoUsers(expirationDate);
